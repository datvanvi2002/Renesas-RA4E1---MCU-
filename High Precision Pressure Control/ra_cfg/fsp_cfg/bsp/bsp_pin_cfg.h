...
#define SW2 (BSP_IO_PORT_01_PIN_02)
#define DIR (BSP_IO_PORT_01_PIN_03)
#define PUL (BSP_IO_PORT_01_PIN_04)
#define PUMP2 (BSP_IO_PORT_01_PIN_05)
#define PMOD1_GPIO_SSLA3 (BSP_IO_PORT_01_PIN_06)
#define PUMP1 (BSP_IO_PORT_01_PIN_07)
...
#define VAL2 (BSP_IO_PORT_01_PIN_13)
#define BT1 (BSP_IO_PORT_02_PIN_05)
#define TCK (BSP_IO_PORT_03_PIN_00)
#define PMOD2_CTS9 (BSP_IO_PORT_03_PIN_01)
#define VAL4 (BSP_IO_PORT_03_PIN_02)
